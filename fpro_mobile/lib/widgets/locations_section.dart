...
class LocationsSection extends StatelessWidget {
  ...
  // Sample rental items - in real app, fetch from backend
  static final List<RentalItem> _sampleRentals = [
    RentalItem(
      id: 'rent_1',
      name: 'Vidéoprojecteur Epson 4K',
      pricePerDay: 15000,
      description: 'Haute luminosité, idéal pour vos présentations en salle.',
      available: true,
    ),
    RentalItem(
      id: 'rent_2',
      ...
      pricePerDay: 12000,
      description: 'Performance professionnelle pour vos déplacements.',
      available: false,
    ),
    RentalItem(
      id: 'rent_3',
      ...
      pricePerDay: 8000,
      description: 'Impression rapide et de qualité pour vos documents.',
      available: true,
    ),
    RentalItem(
      id: 'rent_4',
      ...
      pricePerDay: 20000,
      description: 'Stockage sécurisé pour vos données critiques.',
      available: true,
    ),
  ];
      ...
      child: Row(
        ...
        children: [
          Container(
            ...
            child: const Icon(Icons.devices, size: 30, color: AppColors.mediumGray),
          ),
