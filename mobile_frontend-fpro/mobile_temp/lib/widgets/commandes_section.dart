              ...
              onPressed: cartProvider.isLoading
                  ...
                  : () async {
                      try {
                        ...
                        final companyId = userProfile.profile.companyId;

                        print(
                          'DEBUG: CommandesSection: Retreived companyId: $companyId',
                        );

                        if (companyId == null || companyId.isEmpty) {
                          print(
                            'DEBUG: CommandesSection: companyId is missing!',
                          );
                          throw Exception(
                            "ID d'entreprise manquant (ID: $companyId). Veuillez contacter le support.",
                          );
                        }

                        print(
                          'DEBUG: CommandesSection: Sending confirmOrder with companyId: $companyId',
                        );
                        await cartProvider.confirmOrder(companyId);
                        if (context.mounted) {
