...
class _AdminProductDialogState extends State<AdminProductDialog> {
  ...
  void initState() {
    super.initState();
    final name = widget.isRental
        ? (widget.item as RentalItem?)?.name
        : (widget.item as Product?)?.name;
    final desc = widget.isRental
        ? (widget.item as RentalItem?)?.description
        : (widget.item as Product?)?.description;
    final price = widget.isRental
        ? (widget.item as RentalItem?)?.pricePerDay
        : (widget.item as Product?)?.price;
      ...
      builder: (_, controller) => Container(
        ...
        child: ListView(
          ...
          children: [
            ...
            Wrap(
              spacing: 8,
              children: ['Papier', 'Encres', 'Accessoires', 'Matériel'].map((
                cat,
              ) {
