...
// --- Reviews ---
User.hasMany(Review, { foreignKey: 'client_id', as: 'reviews_written' });
Review.belongsTo(User, { foreignKey: 'client_id', as: 'client' });

User.hasMany(Review, { foreignKey: 'technician_id', as: 'reviews_received' });
Review.belongsTo(User, { foreignKey: 'technician_id', as: 'technician' });

MaintenanceRequest.hasOne(Review, { foreignKey: 'maintenance_id', as: 'review' });
Review.belongsTo(MaintenanceRequest, { foreignKey: 'maintenance_id', as: 'maintenance' });
