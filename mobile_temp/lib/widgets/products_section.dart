...
class _ProductsSectionState extends State<ProductsSection> {
        ...
        Consumer<CartProvider>(
          builder: (context, cart, child) {
            ...
            return Container(
              ...
              child: Row(
                children: [
                  const Icon(Icons.shopping_cart, color: AppColors.primaryBlue, size: 20),
        ...
        Consumer<AdminProvider>(
          builder: (context, admin, child) {
            final filteredProducts = _selectedCategory == 'Tous'
                ? admin.products
                : admin.products.where((p) => p.category == _selectedCategory).toList();

            if (filteredProducts.isEmpty) {
              return const Center(
                child: Padding(
                  padding: EdgeInsets.all(40),
                  child: Text('Aucun produit trouvé dans cette catégorie.', style: TextStyle(color: AppColors.textLight)),
                ),
              );
            }
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    GestureDetector(
                      onTap: () => _showQuantityDialog(id, name, category, price, imageUrl),
                      child: Container(
  ...
  void _showQuantityDialog(String id, String name, String category, double price, String imageUrl) {
    int quantity = 1;
